...
function useDashboardRoutes(): Route[] {
  ...
  return [
    ...
    },
    {
      ...
      subs: [
        { title: t("knowledgeCompanies"), link: "/dashboard/knowledge/companies" },
        { title: t("knowledgeTasks"), link: "/dashboard/knowledge/tasks" },
        { title: t("knowledgePeople"), link: "/dashboard/knowledge/people" },
      ],
    },
    {
      id: "music-bookmarker",
    ...
    {
      id: "stock-and-finance",
      title: t("stockAndFinance"),
      icon: <DollarSign className="size-4" />,
      link: "/dashboard/side-budget",
      subs: [
        { title: t("financeHelper"), link: "/dashboard/finance-helper" },
        { title: t("sideBudget"), link: "/dashboard/side-budget" },
        { title: t("printCalculator"), link: "/dashboard/print-calculator" },
        { title: t("inventory"), link: "/dashboard/inventory" },
        { title: t("invoices"), link: "/dashboard/invoices" },
      ],
    },
    {
      id: "ci-cd-pipelines",
    ...
    },
    {
      ...
      link: "/dashboard/secret-keys",
    },
    {
      id: "secret-accounts",
      title: t("secretAccounts"),
      icon: <UserCog className="size-4" />,
      link: "/dashboard/secret-accounts",
    },
    {
      id: "settings",
      title: t("settings"),
